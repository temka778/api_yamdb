# Generated by Django 3.2 on 2023-04-07 15:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.ManyToManyField(help_text='Жарн, к которому относится произведение', related_name='titles', to='reviews.Genre', verbose_name='Жанр')),
            ],
            options={
